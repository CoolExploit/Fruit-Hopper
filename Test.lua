...
Webhook = "https://discordapp.com/api/webhooks/1177937465558970380/wKtrKRbUQE5r4ezzt3HZTfxIzI1xqQdPDJWrdNebNGn2Cjv7nbZaWt1Fe-DoY3esGULZ" --------------------------------Optional
Store = true  --------------------------------Auto Store after it got the fruit
Safeplace = false ----------------------------- Safeplace 
